...
const provDatabaseDebug = require('debug')('provider:database'); // Models
...
class MongoDB {
  ...
  constructor(database) {
    ...
    if (!database || !database.url) throw new Error('MISSING_DATABASE_CONFIG'); // Configuring database connection
