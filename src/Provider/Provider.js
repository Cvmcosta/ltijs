...
class Provider {
  ...
  setup (encryptionkey, database, options) {
    ...
    this.#server = new Server(options ? options.https : false, options ? options.ssl : false, this.#ENCRYPTIONKEY, options ? options.cors : true, options ? options.serverAddon : false, options ? options.bodyParserOpt : this.#bodyParserOptions)
